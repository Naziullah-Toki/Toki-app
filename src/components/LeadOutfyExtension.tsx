...
export default function LeadOutfyExtension({
  ...
  return (
    <div className="w-[380px] bg-slate-900 text-slate-200 font-sans border border-slate-800 rounded-xl shadow-2xl flex flex-col h-[640px] overflow-hidden" id="leadoutfy-extension">
